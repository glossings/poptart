...
- [ ] Remove hint: `drag to turn · double-click the name to rename · in code: macro1…macro8`
- [ ] Remove hint: `click a pattern to load it into the editor · saved under ~/.poptart/patterns`
