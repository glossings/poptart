...
plays and continuously modulates actual VST/VST3 plugins — Serum, Diva, Vital, the FabFilter and
Soundtoys suites, anything you have installed — instead of samples.
...
That's a bassline in F minor played through Serum, with its filter cutoff swept by a 0.3 Hz sine
in real Hertz. Edit the code, hit eval, and the sound changes underneath your hands.
...
UNLICENSED — not currently licensed for redistribution.
