export { Sig, Signal, n, note, mini, s, synth, sine, saw, tri, square, ramp, rand, perlin, lfo, env, midicc, midikeys, macro, choose, irand, keyboard, tap, midi, audio, pianoroll } from './signal.mjs';
