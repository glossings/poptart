...
const NOTES = Object.freeze({
    ...
    "inputmix": "How much the two channels are summed before the reverb. Up is a mono feed into the tank, which keeps the tail centered; down keeps the sides apart.",
    ...
    "cutoff": "Where the lowpass sits. Because it is inside the feedback, every pass round the tank takes more top off - so the tail gets darker as it goes rather than starting dark.",
    ...
    "crossseed": "How different the left and right sides are. Zero is the same space in both ears; up is two related spaces, which is what makes a wide tail.",
    "tapseed": "Which random arrangement the multitap stage uses. Changing it rearranges the echoes without changing any of the settings above.",
